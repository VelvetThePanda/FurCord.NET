...
namespace FurCord.NET.Testing
{
	public class Program
	{
		public static async Task Main(string[] args)
		{
			...
			ws.MessageReceived += async (_, m) => Console.WriteLine(m.Message);
			await ws.ConnectAsync(new("wss://gateway.discord.gg?v=8&encoding=json"));
			...
			await ws.SendMessageAsync(JsonConvert.SerializeObject(obj));
